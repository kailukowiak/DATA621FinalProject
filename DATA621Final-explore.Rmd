...
```
```{r, include = FALSE}
# c("BsmtExposure", "BsmtFinType2", "MasVnrType", 
#        "MasVnrArea", "Electrical")
# 
# lvs_bsmtExp <- c('No', 'Gd', 'Mn', 'Av', 'NoBsmt')
# month_levels <- c(
...
# unique(original_train$BsmtExposure)
# unique(original_train$MoSold) 
```
