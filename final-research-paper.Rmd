...
The model was tuned using k-fold validation (with 10 folds).

![](https://raw.githubusercontent.com/kaiserxc/DATA621FinalProject/master/report_files/fig4_diag.png)
