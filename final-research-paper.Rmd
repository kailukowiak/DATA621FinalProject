...
One key characteristic that should be taken into account is the correlation between the prices of neighboring houses [@dubin]. This will not be addressed by our project because of complexity and because we do not have specific locations of sold houses. 
...
Functionality	Severely damaged
Quality	Finished basement - None
Neighborhood	Meadow Village - away and next to airport
Functionality	Major deductions 2
Quality	Kitchen - Fair


Neighborhood	Stone Brooke next to Ada Hayden Heritage Park and lake
Functionality	Typical
Zoning	Residential Medium Density
Zoning	Residential High Density
Zoning	Residential Low Density
Zoning	Floating Village Residential
...
pander(coef[,1:3], caption="Linear model coefficient list.",
