...
The effects of this transformation can be see in the scatter plots of the independant variables on SalePrice. The trends are more decernable in the transformed data and the relations are generally more linear (*see figure. 
...
![](https://github.com/kaiserxc/DATA621FinalProject/blob/master/images/Scatter_Trans_and_Imp.png)
\begin{center}
